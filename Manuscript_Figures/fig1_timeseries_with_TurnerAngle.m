...
annotation('textbox', [0.51-0.045, 0.24, 0.25, 0.1], ...   % [x, y, width, height] in normalized figure units
...
annotation('textbox', [0.65, 0.24, 0.2, 0.1], ...   % [x, y, width, height] in normalized figure units
