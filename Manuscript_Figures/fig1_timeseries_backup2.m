...
yyaxis right
l22 = plot(time_Hml, squeeze(eta_grad_mag_weekly)*1e6, 'LineWidth', 2,'Color',brown);
...
print(gcf,'-dpng','-r300',[figdir 'fig1_timeseries2.png']);
...
% hold on;
l32 = plot(time_Hml, Lambda_MLI_mean, 'LineWidth', 2); 
...
set(gca,'FontSize',fontsize);
print(gcf,'-dpng','-r300',[figdir 'fig1_timeseries3.png']);
