...
VHF_steric = ncread(fname,'VHF_theory_steric');
VHF_submeso = ncread(fname,'VHF_theory_submeso');
...
hold on
l_submeso = plot(time, VHF_submeso,'-','Color',blue, 'LineWidth',2);
l_steric = plot(time, VHF_steric, '-.','Color',orange, 'LineWidth',2);
