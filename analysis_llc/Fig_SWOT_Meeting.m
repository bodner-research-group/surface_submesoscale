...
% Left y-axis: Q_net
yyaxis left
l11 = plot(time_qnet, -qnet_7day_smooth, 'Color',[0 0.4470 0.7410], 'LineWidth', 2);
ylabel('\boldmath$\mathcal{Q}_\mathrm{net}\ (\mathrm{W/m^2})$','Interpreter','latex');
ax1 = gca;
ax1.YColor = [0 0.4470 0.7410];  % Blue axis
set(gca,'FontSize', fontsize);
ylim([-400 170]);  % Set y-axis limits correctly
l111 = plot(time_qnet, zeros(1,length(time_qnet)),'--' ,'Color',[0 0.4470 0.7410], 'LineWidth', 0.75);
...
plot(ax3, time_Hml, N2ml_mean_logsafe, 'Color',[0.4660 0.6740 0.1880], 'LineWidth', 2);
...
ax3_label = axes('Position', ax1_pos, ...
                 ...
                 'YAxisLocation', 'right', ...
                 'XAxisLocation', 'bottom', ...
                 'XColor', 'none', 'YColor', [0.4660 0.6740 0.1880]);
...
l13 = legend(ax3, {'Mixed layer stratification'},...
    'TextColor', [0.4660 0.6740 0.1880], 'Location', 'northeast','FontSize',fontsize+2,...
