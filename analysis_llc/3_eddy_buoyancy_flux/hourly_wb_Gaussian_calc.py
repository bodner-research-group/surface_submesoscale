...
out_dir = f"/orcd/data/abodner/002/ysi/surface_submesoscale/analysis_llc/data/{domain_name}/hourly_wb_eddy_gaussian_2sigma"
os.makedirs(out_dir, exist_ok=True)

Lambda_file = (
    f"/orcd/data/abodner/002/ysi/surface_submesoscale/analysis_llc/data/"
    f"{domain_name}/Lambda_MLI_timeseries_daily_surface_reference.nc"
)
...
def main():
    ...
    # ================= RUN =================
    futures = client.compute([process_file(f) for f in target_files])
