...
# ============================================================
def ml_integral(var, Hml, depth, dz, min_H=0):
    """
...
# ============================================================
#         MAIN PER-SNAPSHOT MLD INTEGRAL COMPUTATION
# ============================================================
def compute_mld_integrals_one_time(rho, Hml, w_kp1):
    ...
    b_avg  = ml_integral(b,         Hml, depth, dz3d)
    w_avg  = ml_integral(w_k,       Hml, depth, dz3d)
    wb_avg = ml_integral(w_k * b,   Hml, depth, dz3d)
...
#                          MAIN LOOP
# ============================================================
for rho_file, Hml_file in zip(rho_files, hml_files):
