...
# =====================
# Load Mixed Layer Depth (MLD)
# =====================

# =====================
# Compute Mixed-layer buoyancy
# =====================
...
ds_out.to_netcdf(f"{out_dir}/ML_buoyancy_gradients_daily.nc")

print("✓ Saved daily MLD and mixed-layer buoyancy gradients.")
