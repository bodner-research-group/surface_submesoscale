# !! Note that mean over vertical dimension (k) is incorrect!! Vertical integral should be applied.
...
output_file = os.path.join(f"/orcd/data/abodner/002/ysi/surface_submesoscale/analysis_llc/data/{domain_name}/", "N2ml_weekly_all.nc")
...
plt.tight_layout()
save_path = os.path.join(figdir, "N2ml_mean_timeseries_all.png")
